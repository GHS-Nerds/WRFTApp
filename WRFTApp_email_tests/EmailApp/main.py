...
class EmailInterface(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.sendbutton = Button(text='Send', font_size=16)
...
class IntentButton(Button):
    ...
    def send_email(self, **kwargs):
        email.send(recipient=self.email_recipient, subject=self.email_subject, text=self.email_text, create_chooser=None)
